...
/**
 * A classe Usuario é responsável por gerencias todas as operações
...
class Usuario {
  ...
  /**
   * @throws {InvalidArgumentError} - Esse erro ocorre quando um usuário com
   * o mesmo e-mail já está cadastrado
   */
  async adiciona() {
